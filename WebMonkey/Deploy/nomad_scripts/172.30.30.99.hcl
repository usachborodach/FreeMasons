job "ReportsMonitoring" {
	...
	group "ReportsMonitoring" {
		...
		task "dataharvester" {
			driver = "docker"
			artifact {
				source = "http://172.30.30.99:5657/share/reports_monitoring_container.tar.gz"
			}	
			artifact {
				source = "http://172.30.30.99:5657/share/reports_monitoring_artifacts.zip"
